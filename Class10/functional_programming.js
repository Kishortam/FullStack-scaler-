...
const compute = function(cb) {
    console.log(cb);     // sum function
    // any computation here
    // cb(10, 20)
    console.log(cb(10, 20));  // 30
...
console.log(multiplyFn(1, 5, 3));  // 15
...
console.log(getTotalBillAmount(bills.slice())); // 700 
console.log(bills); // [100, 200, 100, 400]
